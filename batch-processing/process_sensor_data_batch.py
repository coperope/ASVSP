...
# print("Calculating average concentration per node...")
...
# sqlAvgTempHour.show()
# sqlAvgTempHour.coalesce(1).write.csv("hdfs://namenode:9000/results/averageTemperaturePerHourPerNode3.csv", header = 'true')
